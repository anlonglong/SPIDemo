 ...
 */
public class DrawBingView extends View {
    ...
    public DrawBingView(Context context) {
        this(context, null);
    }

    public DrawBingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public DrawBingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
